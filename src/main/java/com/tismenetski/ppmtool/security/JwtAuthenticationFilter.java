...
import com.tismenetski.ppmtool.services.CustomUserDetailsService;
...
import static com.tismenetski.ppmtool.security.SecurityConstants.HEADER_STRING;
import static com.tismenetski.ppmtool.security.SecurityConstants.TOKEN_PREFIX;

//Class to validate the user and the token
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private String getJWTFromRequest(HttpServletRequest request)
    {
        ...
        {
            return bearerToken.substring(7,bearerToken.length()); // Return the token without the "Bearer "
        }
        return null;
    }
}
